...
form.addEventListener("submit",async event => {
  ...
  data.append("report",JSON.stringify({
    ...
    eventDate:$("event-date").value,eventTime:$("event-time").value,timeZone:"Europe/Amsterdam",
